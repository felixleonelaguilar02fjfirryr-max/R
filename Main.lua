...
--// NUEVO: FastlyParse se carga globalmente para que todos los módulos lo usen
_G.FastlyParse = loadstring(game:HttpGet('https://raw.githubusercontent.com/depthso/FastlyParse/refs/heads/main/dist/init.lua'))()
_G.FastlyParse:ImportPlatform("Roblox")
...
print("✅ Sigma Spy iniciado correctamente! +9999999 AURA")